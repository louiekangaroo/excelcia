                        ...
                        <div class="tile-content">
                            <div class="panel" style="height: 100%">
                                ...
                                <div class="content fg-dark clear-float" style="height: 100%">
                                    <img src="images/3.jpg" class="place-left margin10" style="height: 100px">
                                    <h2 class="text-light">CIA - Lorem Ipsum</h2>
                                    <p style="padding:10px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi sodales ligula eget diam vestibulum, nec dignissim risus blandit. Aenean feugiat ex vel lorem accumsan pulvinar. Vestibulum blandit dictum leo, et sagittis felis aliquet id. Nulla a pellentesque est, sollicitudin tincidunt odio. Etiam pulvinar diam lorem, ac consectetur est viverra ac. Aliquam condimentum in lectus nec dignissim. Curabitur elementum viverra lectus eget rhoncus. Maecenas fermentum augue in sem malesuada, sit amet iaculis risus mollis.</p>
                                </div>
                            </div>
                        </div>
                    </div>
